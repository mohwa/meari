 ...
 * @param promises An array which containing the promises
 * @returns {Promise}
 * @example
 ...
 * @param callbacks A function which returns the promise
 * @param [retryCount=0]
 * @param [delayTime=0]
 * @returns {Promise}
 * @example
 ...
 * @param callbacks A function which returns the boolean value
 * @param [retryCount=0]
 * @param [delayTime=0]
 * @returns {Promise}
 * @example
